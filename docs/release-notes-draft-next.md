...
> **SHIPPED — historical.** Everything below went out as v1.0.0-alpha.21
> (prerelease 380442904, 2026-09-01) and v1.0.0-alpha.22 (prerelease 380982465,
> 2026-09-02; notes in the release body and docs/release-justification-alpha22.md).
> Nothing here is pending. Kept for the wording; start a fresh draft for any
> future cut.
