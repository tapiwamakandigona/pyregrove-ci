...
FIGHT WITH INTENT
A three-hit melee combo, chargeable apple throws, and bosses that telegraph
...
- [ ] 5+ landscape screenshots 1920×1080 (capture real screens via the web
      harness: `flutter build web --release -t lib/main_webtest.dart`, then
      screenshot `?screen=`/`?level=` states at 1920×1080)
- [ ] Feature graphic 1024×500 (Pyregrove branding)
