...
//
// Reading easy-mode numbers: the bot often takes MORE hits on easy than
// medium (slower enemies hover beside the dumb bot and re-contact after
// iframes). Humans get more reaction time on easy, so treat easy hit
// counts as a bot artifact, not a difficulty signal — compare medium/hard.
...
const diffName = String.fromEnvironment('DIFF', defaultValue: 'medium');
  ...
  test('wipe probe $target', () {
    for (final seed in seeds) {
      ...
      final topStalls = (stallByCol.entries.toList()
          ...
          .join(' ');
      // ignore: avoid_print
      print('[$target $diffName seed=$seed] '
