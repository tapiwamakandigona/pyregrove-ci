...
// reset-save confirm flow), credits (renders CREDITS.md; since the
// 2026-07-25 original-asset pass it must contain NO CC-BY attribution),
// level select (cards, medals, wallet, boss lock).
import 'dart:io';
