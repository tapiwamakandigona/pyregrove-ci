...
void main() {
  ...
  test('respawn-clear re-disguises a nearby mimic (fresh ambush, fair)', () {
    ...
    s.update(dt, InputIntent()); // session sees died -> _onDeath (hold)
    // The respawn-clear runs when the death hold (kDeathHold) ends.
