...
const _nonEnemyKinds = {
  SpawnKind.player, SpawnKind.exit, SpawnKind.sign, SpawnKind.checkpoint,
  SpawnKind.coin, SpawnKind.apple, SpawnKind.feather, SpawnKind.heart,
  SpawnKind.chest, SpawnKind.secretChest,
};
