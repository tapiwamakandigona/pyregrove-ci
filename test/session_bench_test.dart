...
class BenchStats {
  ...
  double get avg => samplesUs.reduce((a, b) => a + b) / samplesUs.length;
  int at(double q) {
...
void main() {
  test('session update stays far under frame budget '
      '(w1_l5, w1_boss, w1_bonus, w2_l5, w2_boss, w2_bonus)', () {
    for (final id in [
      'w1_l5',
      'w1_boss',
      'w1_bonus',
      'w2_l5', // densest W2 roster: 8 enemies of 7 kinds
      'w2_boss',
      'w2_bonus',
    ]) {
