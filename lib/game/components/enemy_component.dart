...
class EnemyComponent extends PositionComponent
  ...
  static final _dormantPaint = ui.Paint()
    ..colorFilter =
        const ui.ColorFilter.mode(_dormantGrey, ui.BlendMode.modulate);
  ...
  static final _enragePaint = ui.Paint()
    ..colorFilter = const ui.ColorFilter.mode(
        ui.Color(0xFFFFC275), ui.BlendMode.modulate);
  ...
  double get recoilDx => core.hurtFlash > 0
      ? _recoilDir * _recoilPx * (core.hurtFlash / 0.15)
      : 0;
  ...
  Future<void> onLoad() async {
    ...
    switch (core.kind) {
      ...
      case EnemyKind.brambleMimic:
        ...
        _bush = await game.images.load('props/bush.png');
        _main =
            await load('enemies/thornling.png', 6, Vector2(36, 28), 0.13);
        _tint = ui.Paint()
          ..filterQuality = ui.FilterQuality.none
          ..colorFilter = const ui.ColorFilter.mode(
              ui.Color(0xFFB8D97A), ui.BlendMode.modulate);
  ...
  void update(double dt) {
    ...
    if (core.hurtFlash > _lastFlash + 1e-6) {
      _recoilDir =
          core.body.centerX >= game.session.player.body.centerX ? 1 : -1;
    }
  ...
  void _renderBoss(ui.Canvas canvas, SpriteAnimationTicker ticker) {
    ...
    if (core.hurtFlash > 0) {
      ...
      _phasePaint.colorFilter = ui.ColorFilter.mode(
          ui.Color.lerp(const ui.Color(0xFFFFD24A), const ui.Color(0xFFFFFFFF),
              t)!,
          ui.BlendMode.modulate);
      paint = _phasePaint;
