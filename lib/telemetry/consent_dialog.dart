...
// Hosted on the old public repo's GitHub Pages on purpose: the private
// Pyregrove repo cannot serve Pages, the URL is already baked into shipped
// builds, and the page text covers Pyregrove (source: docs/store/ here).
